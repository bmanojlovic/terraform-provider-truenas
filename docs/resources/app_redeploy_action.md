---
page_title: "truenas_app_redeploy_action Resource - terraform-provider-truenas"
subcategory: "Actions"
description: |-
  Name of the application to redeploy (stop, pull latest images, and restart).
---

# truenas_app_redeploy_action (Resource)
...
resource "truenas_app_redeploy_action" "example" {
...
- This resource executes the redeploy action when created
