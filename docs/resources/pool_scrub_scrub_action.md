---
page_title: "truenas_pool_scrub_scrub_action Resource - terraform-provider-truenas"
subcategory: "Actions"
description: |-
  Executes scrub action on pool_scrub resource
---

# truenas_pool_scrub_scrub_action (Resource)
...
resource "truenas_pool_scrub_scrub_action" "example" {
...
- `action` (Optional) - action parameter. Type: `string`
...
- This resource executes the scrub action when created
