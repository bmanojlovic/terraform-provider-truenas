---
page_title: "truenas_app_upgrade_action Resource - terraform-provider-truenas"
subcategory: "Actions"
description: |-
  Executes upgrade action on app resource
---

# truenas_app_upgrade_action (Resource)
...
resource "truenas_app_upgrade_action" "example" {
...
- This resource executes the upgrade action when created
