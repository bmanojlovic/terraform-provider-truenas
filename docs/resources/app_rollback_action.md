---
page_title: "truenas_app_rollback_action Resource - terraform-provider-truenas"
subcategory: "Actions"
description: |-
  Executes rollback action on app resource
---

# truenas_app_rollback_action (Resource)
...
resource "truenas_app_rollback_action" "example" {
