...
func (r *System_GeneralConfigResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if !data.UiCertificate.IsNull() && !data.UiCertificate.IsUnknown() { params["ui_certificate"] = data.UiCertificate.ValueInt64() }
	if !data.UiHttpsport.IsNull() && !data.UiHttpsport.IsUnknown() { params["ui_httpsport"] = data.UiHttpsport.ValueInt64() }
	if !data.UiHttpsredirect.IsNull() && !data.UiHttpsredirect.IsUnknown() { params["ui_httpsredirect"] = data.UiHttpsredirect.ValueBool() }
	if !data.UiPort.IsNull() && !data.UiPort.IsUnknown() { params["ui_port"] = data.UiPort.ValueInt64() }
	if !data.UiConsolemsg.IsNull() && !data.UiConsolemsg.IsUnknown() { params["ui_consolemsg"] = data.UiConsolemsg.ValueBool() }
	if !data.UiXFrameOptions.IsNull() && !data.UiXFrameOptions.IsUnknown() { params["ui_x_frame_options"] = data.UiXFrameOptions.ValueString() }
	if !data.Kbdmap.IsNull() && !data.Kbdmap.IsUnknown() { params["kbdmap"] = data.Kbdmap.ValueString() }
	if !data.Timezone.IsNull() && !data.Timezone.IsUnknown() { params["timezone"] = data.Timezone.ValueString() }
	if !data.UsageCollection.IsNull() && !data.UsageCollection.IsUnknown() { params["usage_collection"] = data.UsageCollection.ValueBool() }
	if !data.DsAuth.IsNull() && !data.DsAuth.IsUnknown() { params["ds_auth"] = data.DsAuth.ValueBool() }
	if !data.UiRestartDelay.IsNull() && !data.UiRestartDelay.IsUnknown() { params["ui_restart_delay"] = data.UiRestartDelay.ValueInt64() }
	if !data.RollbackTimeout.IsNull() && !data.RollbackTimeout.IsUnknown() { params["rollback_timeout"] = data.RollbackTimeout.ValueInt64() }
	...
	if m, ok := result.(map[string]interface{}); ok {
		if v, ok := m["ui_certificate"]; ok { if v == nil { data.UiCertificate = types.Int64Null() } else if f, ok := v.(float64); ok { data.UiCertificate = types.Int64Value(int64(f)) } }
		if v, ok := m["ui_httpsport"]; ok { if v == nil { data.UiHttpsport = types.Int64Null() } else if f, ok := v.(float64); ok { data.UiHttpsport = types.Int64Value(int64(f)) } }
		if v, ok := m["ui_httpsredirect"]; ok { if v == nil { data.UiHttpsredirect = types.BoolNull() } else if b, ok := v.(bool); ok { data.UiHttpsredirect = types.BoolValue(b) } }
		if v, ok := m["ui_port"]; ok { if v == nil { data.UiPort = types.Int64Null() } else if f, ok := v.(float64); ok { data.UiPort = types.Int64Value(int64(f)) } }
		if v, ok := m["ui_consolemsg"]; ok { if v == nil { data.UiConsolemsg = types.BoolNull() } else if b, ok := v.(bool); ok { data.UiConsolemsg = types.BoolValue(b) } }
		if v, ok := m["ui_x_frame_options"]; ok { if v == nil { data.UiXFrameOptions = types.StringNull() } else if s, ok := v.(string); ok { data.UiXFrameOptions = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.UiXFrameOptions = types.StringValue(string(j)) } } }
		if v, ok := m["kbdmap"]; ok { if v == nil { data.Kbdmap = types.StringNull() } else if s, ok := v.(string); ok { data.Kbdmap = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.Kbdmap = types.StringValue(string(j)) } } }
		if v, ok := m["timezone"]; ok { if v == nil { data.Timezone = types.StringNull() } else if s, ok := v.(string); ok { data.Timezone = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.Timezone = types.StringValue(string(j)) } } }
		if v, ok := m["usage_collection"]; ok { if v == nil { data.UsageCollection = types.BoolNull() } else if b, ok := v.(bool); ok { data.UsageCollection = types.BoolValue(b) } }
		if v, ok := m["ds_auth"]; ok { if v == nil { data.DsAuth = types.BoolNull() } else if b, ok := v.(bool); ok { data.DsAuth = types.BoolValue(b) } }
		if v, ok := m["ui_restart_delay"]; ok { if v == nil { data.UiRestartDelay = types.Int64Null() } else if f, ok := v.(float64); ok { data.UiRestartDelay = types.Int64Value(int64(f)) } }
		if v, ok := m["rollback_timeout"]; ok { if v == nil { data.RollbackTimeout = types.Int64Null() } else if f, ok := v.(float64); ok { data.RollbackTimeout = types.Int64Value(int64(f)) } }
	}
