...
type ActionPoolDatasetExport_Keys_For_ReplicationResource struct {
	client *client.Client
}

type ActionPoolDatasetExport_Keys_For_ReplicationResourceModel struct {
...
func NewActionPoolDatasetExport_Keys_For_ReplicationResource() resource.Resource {
	return &ActionPoolDatasetExport_Keys_For_ReplicationResource{}
}

func (r *ActionPoolDatasetExport_Keys_For_ReplicationResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_action_pool_dataset_export_keys_for_replication"
}
...
func (r *ActionPoolDatasetExport_Keys_For_ReplicationResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ActionPoolDatasetExport_Keys_For_ReplicationResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data ActionPoolDatasetExport_Keys_For_ReplicationResourceModel
...
func (r *ActionPoolDatasetExport_Keys_For_ReplicationResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data ActionPoolDatasetExport_Keys_For_ReplicationResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *ActionPoolDatasetExport_Keys_For_ReplicationResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *ActionPoolDatasetExport_Keys_For_ReplicationResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
