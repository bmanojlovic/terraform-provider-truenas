...
func (r *Network_ConfigurationConfigResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if !data.Domain.IsNull() && !data.Domain.IsUnknown() {
		params["domain"] = data.Domain.ValueString()
	}
	if !data.Ipv4Gateway.IsNull() && !data.Ipv4Gateway.IsUnknown() {
		params["ipv4gateway"] = data.Ipv4Gateway.ValueString()
	}
	if !data.Ipv6Gateway.IsNull() && !data.Ipv6Gateway.IsUnknown() {
		params["ipv6gateway"] = data.Ipv6Gateway.ValueString()
	}
	if !data.Nameserver1.IsNull() && !data.Nameserver1.IsUnknown() {
		params["nameserver1"] = data.Nameserver1.ValueString()
	}
	if !data.Nameserver2.IsNull() && !data.Nameserver2.IsUnknown() {
		params["nameserver2"] = data.Nameserver2.ValueString()
	}
	if !data.Nameserver3.IsNull() && !data.Nameserver3.IsUnknown() {
		params["nameserver3"] = data.Nameserver3.ValueString()
	}
	if !data.Httpproxy.IsNull() && !data.Httpproxy.IsUnknown() {
		params["httpproxy"] = data.Httpproxy.ValueString()
	}
	if !data.ServiceAnnouncement.IsNull() && !data.ServiceAnnouncement.IsUnknown() {
		params["service_announcement"] = data.ServiceAnnouncement.ValueString()
	}
	if !data.Activity.IsNull() && !data.Activity.IsUnknown() {
		params["activity"] = data.Activity.ValueString()
	}
	if !data.HostnameB.IsNull() && !data.HostnameB.IsUnknown() {
		params["hostname_b"] = data.HostnameB.ValueString()
	}
	if !data.HostnameVirtual.IsNull() && !data.HostnameVirtual.IsUnknown() {
		params["hostname_virtual"] = data.HostnameVirtual.ValueString()
	}
	...
	if m, ok := result.(map[string]interface{}); ok {
		if v, ok := m["hostname"]; ok {
			if v == nil {
				...
				data.Hostname = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Hostname = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["domain"]; ok {
			if v == nil {
				...
				data.Domain = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Domain = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["ipv4gateway"]; ok {
			if v == nil {
				data.Ipv4Gateway = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.Ipv4Gateway = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Ipv4Gateway = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["ipv6gateway"]; ok {
			if v == nil {
				data.Ipv6Gateway = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.Ipv6Gateway = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Ipv6Gateway = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["nameserver1"]; ok {
			if v == nil {
				data.Nameserver1 = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.Nameserver1 = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Nameserver1 = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["nameserver2"]; ok {
			if v == nil {
				data.Nameserver2 = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.Nameserver2 = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Nameserver2 = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["nameserver3"]; ok {
			if v == nil {
				data.Nameserver3 = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.Nameserver3 = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Nameserver3 = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["httpproxy"]; ok {
			if v == nil {
				data.Httpproxy = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.Httpproxy = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Httpproxy = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["service_announcement"]; ok {
			if v == nil {
				data.ServiceAnnouncement = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.ServiceAnnouncement = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.ServiceAnnouncement = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["activity"]; ok {
			if v == nil {
				data.Activity = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.Activity = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Activity = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["hostname_b"]; ok {
			if v == nil {
				data.HostnameB = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.HostnameB = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.HostnameB = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["hostname_virtual"]; ok {
			if v == nil {
				data.HostnameVirtual = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.HostnameVirtual = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.HostnameVirtual = types.StringValue(string(j))
				}
			}
		}
	}
