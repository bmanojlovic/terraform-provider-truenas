...
type ActionAppConvert_To_CustomResource struct {
	client *client.Client
}

type ActionAppConvert_To_CustomResourceModel struct {
...
func NewActionAppConvert_To_CustomResource() resource.Resource {
	return &ActionAppConvert_To_CustomResource{}
}

func (r *ActionAppConvert_To_CustomResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_action_app_convert_to_custom"
}
...
func (r *ActionAppConvert_To_CustomResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ActionAppConvert_To_CustomResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data ActionAppConvert_To_CustomResourceModel
...
func (r *ActionAppConvert_To_CustomResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data ActionAppConvert_To_CustomResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *ActionAppConvert_To_CustomResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *ActionAppConvert_To_CustomResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
