...
type ActionBootDetachResource struct {
	client *client.Client
}

type ActionBootDetachResourceModel struct {
...
func NewActionBootDetachResource() resource.Resource {
	return &ActionBootDetachResource{}
}

func (r *ActionBootDetachResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_action_boot_detach"
}

func (r *ActionBootDetachResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *ActionBootDetachResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ActionBootDetachResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data ActionBootDetachResourceModel
	...
	// Execute action
	result, err := r.client.Call("boot.detach", params)
	if err != nil {
...
func (r *ActionBootDetachResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data ActionBootDetachResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *ActionBootDetachResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *ActionBootDetachResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
