...
func (r *SnmpConfigResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if !data.Location.IsNull() && !data.Location.IsUnknown() { params["location"] = data.Location.ValueString() }
	if !data.Contact.IsNull() && !data.Contact.IsUnknown() { params["contact"] = data.Contact.ValueString() }
	if !data.Traps.IsNull() && !data.Traps.IsUnknown() { params["traps"] = data.Traps.ValueBool() }
	if !data.V3.IsNull() && !data.V3.IsUnknown() { params["v3"] = data.V3.ValueBool() }
	if !data.Community.IsNull() && !data.Community.IsUnknown() { params["community"] = data.Community.ValueString() }
	if !data.V3Username.IsNull() && !data.V3Username.IsUnknown() { params["v3_username"] = data.V3Username.ValueString() }
	if !data.V3Authtype.IsNull() && !data.V3Authtype.IsUnknown() { params["v3_authtype"] = data.V3Authtype.ValueString() }
	if !data.V3Password.IsNull() && !data.V3Password.IsUnknown() { params["v3_password"] = data.V3Password.ValueString() }
	if !data.V3Privproto.IsNull() && !data.V3Privproto.IsUnknown() { params["v3_privproto"] = data.V3Privproto.ValueString() }
	if !data.V3Privpassphrase.IsNull() && !data.V3Privpassphrase.IsUnknown() { params["v3_privpassphrase"] = data.V3Privpassphrase.ValueString() }
	if !data.Loglevel.IsNull() && !data.Loglevel.IsUnknown() { params["loglevel"] = data.Loglevel.ValueInt64() }
	if !data.Options.IsNull() && !data.Options.IsUnknown() { params["options"] = data.Options.ValueString() }
	if !data.Zilstat.IsNull() && !data.Zilstat.IsUnknown() { params["zilstat"] = data.Zilstat.ValueBool() }
	...
	if m, ok := result.(map[string]interface{}); ok {
		if v, ok := m["location"]; ok { if v == nil { data.Location = types.StringNull() } else if s, ok := v.(string); ok { data.Location = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.Location = types.StringValue(string(j)) } } }
		if v, ok := m["contact"]; ok { if v == nil { data.Contact = types.StringNull() } else if s, ok := v.(string); ok { data.Contact = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.Contact = types.StringValue(string(j)) } } }
		if v, ok := m["traps"]; ok { if v == nil { data.Traps = types.BoolNull() } else if b, ok := v.(bool); ok { data.Traps = types.BoolValue(b) } }
		if v, ok := m["v3"]; ok { if v == nil { data.V3 = types.BoolNull() } else if b, ok := v.(bool); ok { data.V3 = types.BoolValue(b) } }
		if v, ok := m["community"]; ok { if v == nil { data.Community = types.StringNull() } else if s, ok := v.(string); ok { data.Community = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.Community = types.StringValue(string(j)) } } }
		if v, ok := m["v3_username"]; ok { if v == nil { data.V3Username = types.StringNull() } else if s, ok := v.(string); ok { data.V3Username = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.V3Username = types.StringValue(string(j)) } } }
		if v, ok := m["v3_authtype"]; ok { if v == nil { data.V3Authtype = types.StringNull() } else if s, ok := v.(string); ok { data.V3Authtype = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.V3Authtype = types.StringValue(string(j)) } } }
		if v, ok := m["v3_password"]; ok { if v == nil { data.V3Password = types.StringNull() } else if s, ok := v.(string); ok { data.V3Password = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.V3Password = types.StringValue(string(j)) } } }
		if v, ok := m["v3_privproto"]; ok { if v == nil { data.V3Privproto = types.StringNull() } else if s, ok := v.(string); ok { data.V3Privproto = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.V3Privproto = types.StringValue(string(j)) } } }
		if v, ok := m["v3_privpassphrase"]; ok { if v == nil { data.V3Privpassphrase = types.StringNull() } else if s, ok := v.(string); ok { data.V3Privpassphrase = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.V3Privpassphrase = types.StringValue(string(j)) } } }
		if v, ok := m["loglevel"]; ok { if v == nil { data.Loglevel = types.Int64Null() } else if f, ok := v.(float64); ok { data.Loglevel = types.Int64Value(int64(f)) } }
		...
		if v, ok := m["zilstat"]; ok { if v == nil { data.Zilstat = types.BoolNull() } else if b, ok := v.(bool); ok { data.Zilstat = types.BoolValue(b) } }
	}
