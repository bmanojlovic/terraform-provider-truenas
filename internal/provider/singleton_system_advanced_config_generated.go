...
func (r *System_AdvancedConfigResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if !data.Advancedmode.IsNull() && !data.Advancedmode.IsUnknown() { params["advancedmode"] = data.Advancedmode.ValueBool() }
	if !data.Autotune.IsNull() && !data.Autotune.IsUnknown() { params["autotune"] = data.Autotune.ValueBool() }
	if !data.KdumpEnabled.IsNull() && !data.KdumpEnabled.IsUnknown() { params["kdump_enabled"] = data.KdumpEnabled.ValueBool() }
	if !data.BootScrub.IsNull() && !data.BootScrub.IsUnknown() { params["boot_scrub"] = data.BootScrub.ValueInt64() }
	if !data.Consolemenu.IsNull() && !data.Consolemenu.IsUnknown() { params["consolemenu"] = data.Consolemenu.ValueBool() }
	if !data.Consolemsg.IsNull() && !data.Consolemsg.IsUnknown() { params["consolemsg"] = data.Consolemsg.ValueBool() }
	if !data.Debugkernel.IsNull() && !data.Debugkernel.IsUnknown() { params["debugkernel"] = data.Debugkernel.ValueBool() }
	if !data.FqdnSyslog.IsNull() && !data.FqdnSyslog.IsUnknown() { params["fqdn_syslog"] = data.FqdnSyslog.ValueBool() }
	if !data.Motd.IsNull() && !data.Motd.IsUnknown() { params["motd"] = data.Motd.ValueString() }
	if !data.LoginBanner.IsNull() && !data.LoginBanner.IsUnknown() { params["login_banner"] = data.LoginBanner.ValueString() }
	if !data.Powerdaemon.IsNull() && !data.Powerdaemon.IsUnknown() { params["powerdaemon"] = data.Powerdaemon.ValueBool() }
	if !data.Serialconsole.IsNull() && !data.Serialconsole.IsUnknown() { params["serialconsole"] = data.Serialconsole.ValueBool() }
	if !data.Serialport.IsNull() && !data.Serialport.IsUnknown() { params["serialport"] = data.Serialport.ValueString() }
	if !data.Serialspeed.IsNull() && !data.Serialspeed.IsUnknown() { params["serialspeed"] = data.Serialspeed.ValueString() }
	if !data.Overprovision.IsNull() && !data.Overprovision.IsUnknown() { params["overprovision"] = data.Overprovision.ValueInt64() }
	if !data.Traceback.IsNull() && !data.Traceback.IsUnknown() { params["traceback"] = data.Traceback.ValueBool() }
	if !data.Uploadcrash.IsNull() && !data.Uploadcrash.IsUnknown() { params["uploadcrash"] = data.Uploadcrash.ValueBool() }
	if !data.Anonstats.IsNull() && !data.Anonstats.IsUnknown() { params["anonstats"] = data.Anonstats.ValueBool() }
	if !data.SedUser.IsNull() && !data.SedUser.IsUnknown() { params["sed_user"] = data.SedUser.ValueString() }
	if !data.Sysloglevel.IsNull() && !data.Sysloglevel.IsUnknown() { params["sysloglevel"] = data.Sysloglevel.ValueString() }
	if !data.SyslogAudit.IsNull() && !data.SyslogAudit.IsUnknown() { params["syslog_audit"] = data.SyslogAudit.ValueBool() }
	if !data.KernelExtraOptions.IsNull() && !data.KernelExtraOptions.IsUnknown() { params["kernel_extra_options"] = data.KernelExtraOptions.ValueString() }
	if !data.SedPasswd.IsNull() && !data.SedPasswd.IsUnknown() { params["sed_passwd"] = data.SedPasswd.ValueString() }
	...
	if m, ok := result.(map[string]interface{}); ok {
		if v, ok := m["advancedmode"]; ok { if v == nil { data.Advancedmode = types.BoolNull() } else if b, ok := v.(bool); ok { data.Advancedmode = types.BoolValue(b) } }
		if v, ok := m["autotune"]; ok { if v == nil { data.Autotune = types.BoolNull() } else if b, ok := v.(bool); ok { data.Autotune = types.BoolValue(b) } }
		if v, ok := m["kdump_enabled"]; ok { if v == nil { data.KdumpEnabled = types.BoolNull() } else if b, ok := v.(bool); ok { data.KdumpEnabled = types.BoolValue(b) } }
		if v, ok := m["boot_scrub"]; ok { if v == nil { data.BootScrub = types.Int64Null() } else if f, ok := v.(float64); ok { data.BootScrub = types.Int64Value(int64(f)) } }
		if v, ok := m["consolemenu"]; ok { if v == nil { data.Consolemenu = types.BoolNull() } else if b, ok := v.(bool); ok { data.Consolemenu = types.BoolValue(b) } }
		if v, ok := m["consolemsg"]; ok { if v == nil { data.Consolemsg = types.BoolNull() } else if b, ok := v.(bool); ok { data.Consolemsg = types.BoolValue(b) } }
		if v, ok := m["debugkernel"]; ok { if v == nil { data.Debugkernel = types.BoolNull() } else if b, ok := v.(bool); ok { data.Debugkernel = types.BoolValue(b) } }
		if v, ok := m["fqdn_syslog"]; ok { if v == nil { data.FqdnSyslog = types.BoolNull() } else if b, ok := v.(bool); ok { data.FqdnSyslog = types.BoolValue(b) } }
		if v, ok := m["motd"]; ok { if v == nil { data.Motd = types.StringNull() } else if s, ok := v.(string); ok { data.Motd = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.Motd = types.StringValue(string(j)) } } }
		if v, ok := m["login_banner"]; ok { if v == nil { data.LoginBanner = types.StringNull() } else if s, ok := v.(string); ok { data.LoginBanner = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.LoginBanner = types.StringValue(string(j)) } } }
		if v, ok := m["powerdaemon"]; ok { if v == nil { data.Powerdaemon = types.BoolNull() } else if b, ok := v.(bool); ok { data.Powerdaemon = types.BoolValue(b) } }
		if v, ok := m["serialconsole"]; ok { if v == nil { data.Serialconsole = types.BoolNull() } else if b, ok := v.(bool); ok { data.Serialconsole = types.BoolValue(b) } }
		if v, ok := m["serialport"]; ok { if v == nil { data.Serialport = types.StringNull() } else if s, ok := v.(string); ok { data.Serialport = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.Serialport = types.StringValue(string(j)) } } }
		if v, ok := m["serialspeed"]; ok { if v == nil { data.Serialspeed = types.StringNull() } else if s, ok := v.(string); ok { data.Serialspeed = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.Serialspeed = types.StringValue(string(j)) } } }
		if v, ok := m["overprovision"]; ok { if v == nil { data.Overprovision = types.Int64Null() } else if f, ok := v.(float64); ok { data.Overprovision = types.Int64Value(int64(f)) } }
		if v, ok := m["traceback"]; ok { if v == nil { data.Traceback = types.BoolNull() } else if b, ok := v.(bool); ok { data.Traceback = types.BoolValue(b) } }
		if v, ok := m["uploadcrash"]; ok { if v == nil { data.Uploadcrash = types.BoolNull() } else if b, ok := v.(bool); ok { data.Uploadcrash = types.BoolValue(b) } }
		if v, ok := m["anonstats"]; ok { if v == nil { data.Anonstats = types.BoolNull() } else if b, ok := v.(bool); ok { data.Anonstats = types.BoolValue(b) } }
		if v, ok := m["sed_user"]; ok { if v == nil { data.SedUser = types.StringNull() } else if s, ok := v.(string); ok { data.SedUser = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.SedUser = types.StringValue(string(j)) } } }
		if v, ok := m["sysloglevel"]; ok { if v == nil { data.Sysloglevel = types.StringNull() } else if s, ok := v.(string); ok { data.Sysloglevel = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.Sysloglevel = types.StringValue(string(j)) } } }
		if v, ok := m["syslog_audit"]; ok { if v == nil { data.SyslogAudit = types.BoolNull() } else if b, ok := v.(bool); ok { data.SyslogAudit = types.BoolValue(b) } }
		if v, ok := m["kernel_extra_options"]; ok { if v == nil { data.KernelExtraOptions = types.StringNull() } else if s, ok := v.(string); ok { data.KernelExtraOptions = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.KernelExtraOptions = types.StringValue(string(j)) } } }
		if v, ok := m["sed_passwd"]; ok { if v == nil { data.SedPasswd = types.StringNull() } else if s, ok := v.(string); ok { data.SedPasswd = types.StringValue(s) } else { if j, e := json.Marshal(v); e == nil { data.SedPasswd = types.StringValue(string(j)) } } }
	}
