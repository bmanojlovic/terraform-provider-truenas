...
func (d *PoolDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if v, ok := resultMap["scan"]; ok {
		if v == nil {
			data.Scan = types.StringNull()
		} else {
			switch val := v.(type) {
			case string:
	...
	if v, ok := resultMap["expand"]; ok {
		if v == nil {
			data.Expand = types.StringNull()
		} else {
			switch val := v.(type) {
			case string:
	...
	if v, ok := resultMap["is_upgraded"]; ok {
		if bv, ok := v.(bool); ok {
			data.IsUpgraded = types.BoolValue(bv)
		}
	}
	if v, ok := resultMap["healthy"]; ok {
		if bv, ok := v.(bool); ok {
			data.Healthy = types.BoolValue(bv)
		}
	}
	if v, ok := resultMap["warning"]; ok {
		if bv, ok := v.(bool); ok {
			data.Warning = types.BoolValue(bv)
		}
	}
	if v, ok := resultMap["status_code"]; ok {
		if v == nil {
	...
	if v, ok := resultMap["status_detail"]; ok {
		if v == nil {
			data.StatusDetail = types.StringNull()
		} else {
			switch val := v.(type) {
			case string:
	...
	if v, ok := resultMap["allocated"]; ok {
		if v == nil {
			data.Allocated = types.Int64Null()
		} else {
			switch val := v.(type) {
			case float64:
	...
	if v, ok := resultMap["free"]; ok {
		if v == nil {
			data.Free = types.Int64Null()
		} else {
			switch val := v.(type) {
			case float64:
	...
	if v, ok := resultMap["freeing"]; ok {
		if v == nil {
			data.Freeing = types.Int64Null()
		} else {
			switch val := v.(type) {
			case float64:
	...
	if v, ok := resultMap["dedup_table_size"]; ok {
		if v == nil {
			data.DedupTableSize = types.Int64Null()
		} else {
			switch val := v.(type) {
			case float64:
	...
	if v, ok := resultMap["dedup_table_quota"]; ok {
		if v == nil {
			data.DedupTableQuota = types.StringNull()
		} else {
			switch val := v.(type) {
			case string:
	...
	if v, ok := resultMap["fragmentation"]; ok {
		if v == nil {
			data.Fragmentation = types.StringNull()
		} else {
			switch val := v.(type) {
			case string:
	...
	if v, ok := resultMap["size_str"]; ok {
		if v == nil {
			data.SizeStr = types.StringNull()
		} else {
			switch val := v.(type) {
			case string:
	...
	if v, ok := resultMap["allocated_str"]; ok {
		if v == nil {
			data.AllocatedStr = types.StringNull()
		} else {
			switch val := v.(type) {
			case string:
	...
	if v, ok := resultMap["free_str"]; ok {
		if v == nil {
			data.FreeStr = types.StringNull()
		} else {
			switch val := v.(type) {
			case string:
	...
	if v, ok := resultMap["freeing_str"]; ok {
		if v == nil {
			data.FreeingStr = types.StringNull()
		} else {
			switch val := v.(type) {
			case string:
	...
	if v, ok := resultMap["topology"]; ok {
		if v == nil {
			data.Topology = types.StringNull()
		} else {
			switch val := v.(type) {
			case string:
	...
	if data.Scan.IsUnknown() {
		data.Scan = types.StringNull()
	}
	if data.Expand.IsUnknown() {
		data.Expand = types.StringNull()
	}
	if data.IsUpgraded.IsUnknown() {
		data.IsUpgraded = types.BoolNull()
	}
	if data.Healthy.IsUnknown() {
		data.Healthy = types.BoolNull()
	}
	if data.Warning.IsUnknown() {
		data.Warning = types.BoolNull()
	}
	if data.StatusCode.IsUnknown() {
		data.StatusCode = types.StringNull()
	}
	if data.StatusDetail.IsUnknown() {
		data.StatusDetail = types.StringNull()
	}
	if data.Size.IsUnknown() {
		data.Size = types.Int64Null()
	}
	if data.Allocated.IsUnknown() {
		data.Allocated = types.Int64Null()
	}
	if data.Free.IsUnknown() {
		data.Free = types.Int64Null()
	}
	if data.Freeing.IsUnknown() {
		data.Freeing = types.Int64Null()
	}
	if data.DedupTableSize.IsUnknown() {
		data.DedupTableSize = types.Int64Null()
	}
	if data.DedupTableQuota.IsUnknown() {
		data.DedupTableQuota = types.StringNull()
	}
	if data.Fragmentation.IsUnknown() {
		data.Fragmentation = types.StringNull()
	}
	if data.SizeStr.IsUnknown() {
		data.SizeStr = types.StringNull()
	}
	if data.AllocatedStr.IsUnknown() {
		data.AllocatedStr = types.StringNull()
	}
	if data.FreeStr.IsUnknown() {
		data.FreeStr = types.StringNull()
	}
	if data.FreeingStr.IsUnknown() {
		data.FreeingStr = types.StringNull()
	}
	if data.Autotrim.IsUnknown() {
		data.Autotrim = types.StringNull()
	}
	if data.Topology.IsUnknown() {
		data.Topology = types.StringNull()
	}
