...
type ActionPoolDatasetDestroy_SnapshotsResource struct {
...
func NewActionPoolDatasetDestroy_SnapshotsResource() resource.Resource {
	return &ActionPoolDatasetDestroy_SnapshotsResource{}
}

func (r *ActionPoolDatasetDestroy_SnapshotsResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_action_pool_dataset_destroy_snapshots"
}
...
func (r *ActionPoolDatasetDestroy_SnapshotsResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ActionPoolDatasetDestroy_SnapshotsResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data ActionPoolDatasetDestroy_SnapshotsResourceModel
	...
	if err != nil {
		resp.Diagnostics.AddError("Action Failed", fmt.Sprintf("Failed to execute pool.dataset.destroy_snapshots: %s", err.Error()))
		return
	}
	...
	data.ActionID = types.StringValue(fmt.Sprintf("pool.dataset.destroy_snapshots-%d", time.Now().Unix()))
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *ActionPoolDatasetDestroy_SnapshotsResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data ActionPoolDatasetDestroy_SnapshotsResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *ActionPoolDatasetDestroy_SnapshotsResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *ActionPoolDatasetDestroy_SnapshotsResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
