...
type Cloud_BackupDelete_SnapshotResource struct {
...
func NewCloud_BackupDelete_SnapshotResource() resource.Resource {
	return &Cloud_BackupDelete_SnapshotResource{}
}

func (r *Cloud_BackupDelete_SnapshotResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_cloud_backup_delete_snapshot"
}

func (r *Cloud_BackupDelete_SnapshotResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *Cloud_BackupDelete_SnapshotResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *Cloud_BackupDelete_SnapshotResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data Cloud_BackupDelete_SnapshotResourceModel
	...
	data.ActionID = types.StringValue(fmt.Sprintf("cloud_backup.delete_snapshot-%d", time.Now().Unix()))
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *Cloud_BackupDelete_SnapshotResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data Cloud_BackupDelete_SnapshotResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *Cloud_BackupDelete_SnapshotResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *Cloud_BackupDelete_SnapshotResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
