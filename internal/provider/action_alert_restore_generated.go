...
type ActionAlertRestoreResource struct {
	client *client.Client
}

type ActionAlertRestoreResourceModel struct {
...
func NewActionAlertRestoreResource() resource.Resource {
	return &ActionAlertRestoreResource{}
}

func (r *ActionAlertRestoreResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_action_alert_restore"
}
...
func (r *ActionAlertRestoreResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ActionAlertRestoreResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data ActionAlertRestoreResourceModel
	...
	// Execute action
	result, err := r.client.Call("alert.restore", params)
	if err != nil {
...
func (r *ActionAlertRestoreResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data ActionAlertRestoreResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *ActionAlertRestoreResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *ActionAlertRestoreResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
