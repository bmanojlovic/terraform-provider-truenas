...
type PoolDdt_PrefetchResource struct {
	client *client.Client
}

type PoolDdt_PrefetchResourceModel struct {
...
func NewPoolDdt_PrefetchResource() resource.Resource {
	return &PoolDdt_PrefetchResource{}
}

func (r *PoolDdt_PrefetchResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_pool_ddt_prefetch"
}

func (r *PoolDdt_PrefetchResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *PoolDdt_PrefetchResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *PoolDdt_PrefetchResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data PoolDdt_PrefetchResourceModel
	...
	data.ActionID = types.StringValue(fmt.Sprintf("pool.ddt_prefetch-%d", time.Now().Unix()))
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *PoolDdt_PrefetchResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data PoolDdt_PrefetchResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *PoolDdt_PrefetchResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *PoolDdt_PrefetchResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
