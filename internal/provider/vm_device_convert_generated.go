...
type VmDeviceConvertResource struct {
...
func NewVmDeviceConvertResource() resource.Resource {
	return &VmDeviceConvertResource{}
}

func (r *VmDeviceConvertResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_vm_device_convert"
}

func (r *VmDeviceConvertResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *VmDeviceConvertResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *VmDeviceConvertResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data VmDeviceConvertResourceModel
	...
	data.ActionID = types.StringValue(fmt.Sprintf("vm.device.convert-%d", time.Now().Unix()))
	resp.Diagnostics.Append(resp.State.Set(ctx, &data)...)
}

func (r *VmDeviceConvertResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data VmDeviceConvertResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *VmDeviceConvertResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *VmDeviceConvertResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
