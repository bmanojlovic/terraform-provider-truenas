...
func (r *SmbConfigResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if !data.Netbiosname.IsNull() && !data.Netbiosname.IsUnknown() {
		params["netbiosname"] = data.Netbiosname.ValueString()
	}
	if !data.Workgroup.IsNull() && !data.Workgroup.IsUnknown() {
		params["workgroup"] = data.Workgroup.ValueString()
	}
	if !data.Description.IsNull() && !data.Description.IsUnknown() {
		params["description"] = data.Description.ValueString()
	}
	if !data.EnableSmb1.IsNull() && !data.EnableSmb1.IsUnknown() {
		params["enable_smb1"] = data.EnableSmb1.ValueBool()
	}
	if !data.Unixcharset.IsNull() && !data.Unixcharset.IsUnknown() {
		params["unixcharset"] = data.Unixcharset.ValueString()
	}
	if !data.Localmaster.IsNull() && !data.Localmaster.IsUnknown() {
		params["localmaster"] = data.Localmaster.ValueBool()
	}
	if !data.Syslog.IsNull() && !data.Syslog.IsUnknown() {
		params["syslog"] = data.Syslog.ValueBool()
	}
	if !data.AaplExtensions.IsNull() && !data.AaplExtensions.IsUnknown() {
		params["aapl_extensions"] = data.AaplExtensions.ValueBool()
	}
	if !data.AdminGroup.IsNull() && !data.AdminGroup.IsUnknown() {
		params["admin_group"] = data.AdminGroup.ValueString()
	}
	if !data.Guest.IsNull() && !data.Guest.IsUnknown() {
		params["guest"] = data.Guest.ValueString()
	}
	...
	if !data.Ntlmv1Auth.IsNull() && !data.Ntlmv1Auth.IsUnknown() {
		params["ntlmv1_auth"] = data.Ntlmv1Auth.ValueBool()
	}
	if !data.Multichannel.IsNull() && !data.Multichannel.IsUnknown() {
		params["multichannel"] = data.Multichannel.ValueBool()
	}
	if !data.Encryption.IsNull() && !data.Encryption.IsUnknown() {
		params["encryption"] = data.Encryption.ValueString()
	}
	if !data.ServerSid.IsNull() && !data.ServerSid.IsUnknown() {
		params["server_sid"] = data.ServerSid.ValueString()
	}
	if !data.SmbOptions.IsNull() && !data.SmbOptions.IsUnknown() {
		params["smb_options"] = data.SmbOptions.ValueString()
	}
	if !data.Debug.IsNull() && !data.Debug.IsUnknown() {
		params["debug"] = data.Debug.ValueBool()
	}
	...
	if m, ok := result.(map[string]interface{}); ok {
		if v, ok := m["netbiosname"]; ok {
			if v == nil {
				data.Netbiosname = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.Netbiosname = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Netbiosname = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["workgroup"]; ok {
			if v == nil {
				data.Workgroup = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.Workgroup = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Workgroup = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["description"]; ok {
			if v == nil {
				...
				data.Description = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Description = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["enable_smb1"]; ok {
			if v == nil {
				data.EnableSmb1 = types.BoolNull()
			} else if b, ok := v.(bool); ok {
				data.EnableSmb1 = types.BoolValue(b)
			}
		}
		if v, ok := m["unixcharset"]; ok {
			if v == nil {
				data.Unixcharset = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.Unixcharset = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Unixcharset = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["localmaster"]; ok {
			if v == nil {
				data.Localmaster = types.BoolNull()
			} else if b, ok := v.(bool); ok {
				data.Localmaster = types.BoolValue(b)
			}
		}
		if v, ok := m["syslog"]; ok {
			if v == nil {
				data.Syslog = types.BoolNull()
			} else if b, ok := v.(bool); ok {
				data.Syslog = types.BoolValue(b)
			}
		}
		if v, ok := m["aapl_extensions"]; ok {
			if v == nil {
				data.AaplExtensions = types.BoolNull()
			} else if b, ok := v.(bool); ok {
				data.AaplExtensions = types.BoolValue(b)
			}
		}
		if v, ok := m["admin_group"]; ok {
			if v == nil {
				data.AdminGroup = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.AdminGroup = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.AdminGroup = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["guest"]; ok {
			if v == nil {
				data.Guest = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.Guest = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Guest = types.StringValue(string(j))
				}
			}
		}
		...
		if v, ok := m["ntlmv1_auth"]; ok {
			if v == nil {
				data.Ntlmv1Auth = types.BoolNull()
			} else if b, ok := v.(bool); ok {
				data.Ntlmv1Auth = types.BoolValue(b)
			}
		}
		if v, ok := m["multichannel"]; ok {
			if v == nil {
				data.Multichannel = types.BoolNull()
			} else if b, ok := v.(bool); ok {
				data.Multichannel = types.BoolValue(b)
			}
		}
		if v, ok := m["encryption"]; ok {
			if v == nil {
				...
				data.Encryption = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.Encryption = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["server_sid"]; ok {
			if v == nil {
				data.ServerSid = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.ServerSid = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.ServerSid = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["smb_options"]; ok {
			if v == nil {
				data.SmbOptions = types.StringNull()
			} else if s, ok := v.(string); ok {
				data.SmbOptions = types.StringValue(s)
			} else {
				if j, e := json.Marshal(v); e == nil {
					data.SmbOptions = types.StringValue(string(j))
				}
			}
		}
		if v, ok := m["debug"]; ok {
