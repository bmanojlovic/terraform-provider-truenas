...
type VirtDeviceExport_Disk_ImageResource struct {
...
func NewVirtDeviceExport_Disk_ImageResource() resource.Resource {
	return &VirtDeviceExport_Disk_ImageResource{}
}

func (r *VirtDeviceExport_Disk_ImageResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_virt_device_export_disk_image"
}

func (r *VirtDeviceExport_Disk_ImageResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *VirtDeviceExport_Disk_ImageResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *VirtDeviceExport_Disk_ImageResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data VirtDeviceExport_Disk_ImageResourceModel
	...
	// Execute action
	result, err := r.client.Call("virt.device.export_disk_image", paramsArr)
	if err != nil {
...
func (r *VirtDeviceExport_Disk_ImageResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data VirtDeviceExport_Disk_ImageResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *VirtDeviceExport_Disk_ImageResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *VirtDeviceExport_Disk_ImageResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
