...
type ActionSystemGeneralUi_RestartResource struct {
	client *client.Client
}

type ActionSystemGeneralUi_RestartResourceModel struct {
...
func NewActionSystemGeneralUi_RestartResource() resource.Resource {
	return &ActionSystemGeneralUi_RestartResource{}
}

func (r *ActionSystemGeneralUi_RestartResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_action_system_general_ui_restart"
}
...
func (r *ActionSystemGeneralUi_RestartResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ActionSystemGeneralUi_RestartResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data ActionSystemGeneralUi_RestartResourceModel
	...
	// Execute action
	result, err := r.client.Call("system.general.ui_restart", params)
	if err != nil {
...
func (r *ActionSystemGeneralUi_RestartResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data ActionSystemGeneralUi_RestartResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *ActionSystemGeneralUi_RestartResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *ActionSystemGeneralUi_RestartResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
