...
type ActionDirectoryservicesLeaveResource struct {
	client *client.Client
}

type ActionDirectoryservicesLeaveResourceModel struct {
...
func NewActionDirectoryservicesLeaveResource() resource.Resource {
	return &ActionDirectoryservicesLeaveResource{}
}

func (r *ActionDirectoryservicesLeaveResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_action_directoryservices_leave"
}
...
func (r *ActionDirectoryservicesLeaveResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ActionDirectoryservicesLeaveResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data ActionDirectoryservicesLeaveResourceModel
	...
	// Build parameters
	params := []interface{}{}
	var credentialVal interface{}
	if err := json.Unmarshal([]byte(data.Credential.ValueString()), &credentialVal); err == nil {
		params = append(params, credentialVal)
	}

	// Execute action
	result, err := r.client.Call("directoryservices.leave", params)
	if err != nil {
...
func (r *ActionDirectoryservicesLeaveResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data ActionDirectoryservicesLeaveResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *ActionDirectoryservicesLeaveResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *ActionDirectoryservicesLeaveResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
