...
func (d *PoolDatasetDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	if data.Encrypted.IsUnknown() {
		data.Encrypted = types.BoolNull()
	}
	if data.EncryptionRoot.IsUnknown() {
		data.EncryptionRoot = types.StringNull()
	}
	if data.KeyLoaded.IsUnknown() {
		data.KeyLoaded = types.BoolNull()
	}
	if data.Children.IsUnknown() {
		data.Children, _ = types.ListValue(types.StringType, []attr.Value{})
	}
	if data.UserProperties.IsUnknown() {
		data.UserProperties = types.StringNull()
	}
	if data.Locked.IsUnknown() {
		data.Locked = types.BoolNull()
	}
	if data.Comments.IsUnknown() {
		data.Comments = types.StringNull()
	}
	if data.QuotaWarning.IsUnknown() {
		data.QuotaWarning = types.StringNull()
	}
	if data.QuotaCritical.IsUnknown() {
		data.QuotaCritical = types.StringNull()
	}
	if data.RefquotaWarning.IsUnknown() {
		data.RefquotaWarning = types.StringNull()
	}
	if data.RefquotaCritical.IsUnknown() {
		data.RefquotaCritical = types.StringNull()
	}
	if data.Managedby.IsUnknown() {
		data.Managedby = types.StringNull()
	}
	if data.Deduplication.IsUnknown() {
		data.Deduplication = types.StringNull()
	}
	if data.Aclmode.IsUnknown() {
		data.Aclmode = types.StringNull()
	}
	if data.Acltype.IsUnknown() {
		data.Acltype = types.StringNull()
	}
	if data.Xattr.IsUnknown() {
		data.Xattr = types.StringNull()
	}
	if data.Atime.IsUnknown() {
		data.Atime = types.StringNull()
	}
	if data.Casesensitivity.IsUnknown() {
		data.Casesensitivity = types.StringNull()
	}
	if data.Checksum.IsUnknown() {
		data.Checksum = types.StringNull()
	}
	if data.Exec.IsUnknown() {
		data.Exec = types.StringNull()
	}
	if data.Sync.IsUnknown() {
		data.Sync = types.StringNull()
	}
	if data.Compression.IsUnknown() {
		data.Compression = types.StringNull()
	}
	if data.Compressratio.IsUnknown() {
		data.Compressratio = types.StringNull()
	}
	if data.Origin.IsUnknown() {
		data.Origin = types.StringNull()
	}
	if data.Quota.IsUnknown() {
		data.Quota = types.StringNull()
	}
	if data.Refquota.IsUnknown() {
		data.Refquota = types.StringNull()
	}
	if data.Reservation.IsUnknown() {
		data.Reservation = types.StringNull()
	}
	if data.Refreservation.IsUnknown() {
		data.Refreservation = types.StringNull()
	}
	if data.Copies.IsUnknown() {
		data.Copies = types.StringNull()
	}
	if data.Snapdir.IsUnknown() {
		data.Snapdir = types.StringNull()
	}
	if data.Readonly.IsUnknown() {
		data.Readonly = types.StringNull()
	}
	if data.Recordsize.IsUnknown() {
		data.Recordsize = types.StringNull()
	}
	if data.Sparse.IsUnknown() {
		data.Sparse = types.StringNull()
	}
	if data.Volsize.IsUnknown() {
		data.Volsize = types.StringNull()
	}
	if data.Volblocksize.IsUnknown() {
		data.Volblocksize = types.StringNull()
	}
	if data.KeyFormat.IsUnknown() {
		data.KeyFormat = types.StringNull()
	}
	if data.EncryptionAlgorithm.IsUnknown() {
		data.EncryptionAlgorithm = types.StringNull()
	}
	if data.Used.IsUnknown() {
		data.Used = types.StringNull()
	}
	if data.Usedbychildren.IsUnknown() {
		data.Usedbychildren = types.StringNull()
	}
	if data.Usedbydataset.IsUnknown() {
		data.Usedbydataset = types.StringNull()
	}
	if data.Usedbyrefreservation.IsUnknown() {
		data.Usedbyrefreservation = types.StringNull()
	}
	if data.Usedbysnapshots.IsUnknown() {
		data.Usedbysnapshots = types.StringNull()
	}
	if data.Available.IsUnknown() {
		data.Available = types.StringNull()
	}
	if data.SpecialSmallBlockSize.IsUnknown() {
		data.SpecialSmallBlockSize = types.StringNull()
	}
	if data.Pbkdf2Iters.IsUnknown() {
		data.Pbkdf2Iters = types.StringNull()
	}
	if data.Creation.IsUnknown() {
		data.Creation = types.StringNull()
	}
	if data.Snapdev.IsUnknown() {
		data.Snapdev = types.StringNull()
	}
	if data.Mountpoint.IsUnknown() {
		data.Mountpoint = types.StringNull()
	}
