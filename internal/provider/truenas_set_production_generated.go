...
type TruenasSet_ProductionResource struct {
...
func NewTruenasSet_ProductionResource() resource.Resource {
	return &TruenasSet_ProductionResource{}
}

func (r *TruenasSet_ProductionResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_truenas_set_production"
}

func (r *TruenasSet_ProductionResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
...
func (r *TruenasSet_ProductionResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *TruenasSet_ProductionResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data TruenasSet_ProductionResourceModel
...
func (r *TruenasSet_ProductionResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	// Actions are immutable - just return current state
	var data TruenasSet_ProductionResourceModel
	resp.Diagnostics.Append(req.State.Get(ctx, &data)...)
}

func (r *TruenasSet_ProductionResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	resp.Diagnostics.AddError("Update Not Supported", "Actions cannot be updated, only recreated")
}

func (r *TruenasSet_ProductionResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
